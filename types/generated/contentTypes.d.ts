...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<'plugin::rich-body.rich-body'>;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.Enumeration<
      ['emerald', 'amber', 'blue', 'purple', 'red', 'lime', 'zinc']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'zinc'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiClubClub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    country: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Kenya'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    venueCapacity: Schema.Attribute.Integer;
    venueCity: Schema.Attribute.String;
...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contractUntil: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    nationalityCode: Schema.Attribute.String & Schema.Attribute.Required;
    nationalityFlag: Schema.Attribute.String & Schema.Attribute.Required;
    nationalityName: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Required;
    preferredFoot: Schema.Attribute.Enumeration<['right', 'left', 'both']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    secondaryPosition: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    statsAppearances: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    statsAssists: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    statsCleanSheets: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    statsGoals: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    statsMinutesPlayed: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    statsRedCards: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    statsYellowCards: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStandingStanding extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    competitionCountry: Schema.Attribute.String & Schema.Attribute.Required;
    competitionId: Schema.Attribute.String & Schema.Attribute.Required;
    competitionLogo: Schema.Attribute.String & Schema.Attribute.Required;
    competitionName: Schema.Attribute.String & Schema.Attribute.Required;
    competitionSlug: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    seasonId: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTournamentTournament extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    groupStageEnd: Schema.Attribute.String;
    hostCities: Schema.Attribute.JSON;
    hostCountries: Schema.Attribute.JSON;
    knockoutStart: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTransferTransfer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    confidence: Schema.Attribute.Enumeration<['hot', 'warm', 'cool']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    window: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
